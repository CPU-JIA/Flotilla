...
**标题（中文）**: "Flotilla - 让分布式团队像分布式系统一样可靠 | Raft 共识算法实战"

**标题（英文）**: "Flotilla - We Build Consensus, Not Just Code | Raft Algorithm in Action"

**描述（中英双语）**:
```
We don't just host code. We build consensus.

Flotilla 是一个基于 Raft 共识算法的云原生开发协作平台。
...
**标题**: "【开源项目】用 Raft 算法重新定义团队协作 | Flotilla 技术解析"
