...
| 技术 | 版本 | 用途 | 选型理由 |
|------|------|------|----------|
| **Next.js** | 15.5.x | React框架 | SSR/SSG支持，App Router，性能优异 |
...
│   ├── email/                # 邮件服务 ✅
│   ├── redis/                # Redis服务 ✅
│   ├── pipelines/            # CI/CD流水线 ✅ 新增
│   ├── wiki/                 # Wiki文档系统 ✅ 新增
│   ├── webhooks/             # Webhook事件推送 ✅ 新增
│   ├── collaboration/        # 实时协作编辑 ✅ 新增
│   ├── gdpr/                 # GDPR数据导出 ✅ 新增
...
graph LR
    ...
    AppModule --> PipelinesModule[Pipelines Module ✅]
    AppModule --> WikiModule[Wiki Module ✅]
    AppModule --> WebhooksModule[Webhooks Module ✅]
    AppModule --> CollaborationModule[Collaboration Module ✅]
    AppModule --> GdprModule[GDPR Module ✅]

    AuthModule --> UsersModule
    AuthModule --> DatabaseModule
    AuthModule --> EmailModule[Email Module ✅]
    AuthModule --> RedisModule[Redis Module ✅]
    AuthModule --> ApiTokensModule[API Tokens ✅]
    AuthModule --> OAuthModule[OAuth Module ✅]
    AuthModule --> TwoFactorModule[Two-Factor Module ✅]
    ...
    CollaborationModule --> UsersModule
