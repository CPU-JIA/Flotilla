...
describe('PipelinesService', () => {
  ...
  describe('createPipeline', () => {
    ...
    it('should throw NotFoundException if project does not exist', async () => {
      ...
      await expect(service.createPipeline(projectId, createDto)).rejects.toThrow(
        NotFoundException,
      )
    })
  ...
  describe('updatePipeline', () => {
    ...
    it('should throw BadRequestException if new name conflicts', async () => {
      ...
      await expect(service.updatePipeline(pipelineId, updateDto)).rejects.toThrow(
        BadRequestException,
      )
    })
  })
  ...
  describe('triggerPipeline', () => {
    ...
    it('should throw BadRequestException if pipeline is not active', async () => {
      ...
      await expect(service.triggerPipeline(pipelineId, triggerDto)).rejects.toThrow(
        BadRequestException,
      )
    })
  })
  ...
  describe('getPipelineRuns', () => {
    ...
    it('should return paginated pipeline runs', async () => {
      mockPrismaService.pipeline.findUnique.mockResolvedValue({ id: pipelineId })
