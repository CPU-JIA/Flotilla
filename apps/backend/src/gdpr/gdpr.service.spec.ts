...
describe('GdprService', () => {
  ...
  describe('collectUserData', () => {
    ...
    it('should throw NotFoundException if user not found', async () => {
      ...
      await expect(service.collectUserData(userId)).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('getExportStatus', () => {
    ...
    it('should throw error if export not found', async () => {
      ...
      await expect(service.getExportStatus(exportId, userId)).rejects.toThrow(NotFoundException)
    })
  ...
  describe('getUserExports', () => {
    it('should return user export history', async () => {
      ...
      mockPrismaService.dataExportRequest.findMany.mockResolvedValue(mockExports)
  ...
  describe('downloadExport', () => {
    it('should return download URL for completed export', async () => {
      ...
      mockMinioService.getFileUrl.mockResolvedValue('http://minio.example.com/download-url')
  ...
  describe('cleanupExpiredExports', () => {
    it('should cleanup expired exports', async () => {
      ...
      expect(mockPrismaService.dataExportRequest.update).toHaveBeenCalledTimes(2)
    })
