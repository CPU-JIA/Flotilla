...
describe('WikiController', () => {
  ...
  describe('createPage', () => {
    ...
    it('should throw if user lacks MEMBER permission', async () => {
      ...
      await expect(
        controller.createPage(projectId, mockUser, createDto),
      ).rejects.toThrow();
  ...
  describe('getWikiTree', () => {
    ...
    it('should return wiki tree with VIEWER permission', async () => {
      ...
      const result = await controller.getWikiTree(projectId, mockUser);
  ...
  describe('getPage', () => {
    ...
    it('should return a page with VIEWER permission', async () => {
      ...
      const result = await controller.getPage(projectId, slug, mockUser);
  ...
  describe('updatePage', () => {
    ...
    it('should throw if user lacks MEMBER permission', async () => {
      ...
      await expect(
        controller.updatePage(projectId, slug, mockUser, updateDto),
      ).rejects.toThrow();
  ...
  describe('deletePage', () => {
    ...
    it('should delete a page with MAINTAINER permission', async () => {
      ...
      await controller.deletePage(projectId, slug, mockUser);
    ...
    it('should throw if user lacks MAINTAINER permission', async () => {
      ...
      await expect(
        controller.deletePage(projectId, slug, mockUser),
      ).rejects.toThrow();
  ...
  describe('getPageHistory', () => {
    ...
    it('should return page history with VIEWER permission', async () => {
      ...
      const result = await controller.getPageHistory(projectId, slug, mockUser);
