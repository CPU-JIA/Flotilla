...
export interface RaftTransport {
  sendRequestVote(nodeId: string, request: RequestVoteRequest): Promise<RequestVoteResponse>
  sendAppendEntries(nodeId: string, request: AppendEntriesRequest): Promise<AppendEntriesResponse>
