          ...
          <div className="flex flex-col space-y-4 mt-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                variant="outline"
                onClick={() => {
                  window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/auth/oauth/github`
                }}
                disabled={isLoading}
              >
              ...
              <Button
                ...
                variant="outline"
                onClick={() => {
                  window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/auth/oauth/google`
                }}
                disabled={isLoading}
              >
