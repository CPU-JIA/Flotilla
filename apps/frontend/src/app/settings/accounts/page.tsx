...
const providerConfig = {
  github: {
    ...
    linkUrl: '/api/auth/oauth/github/link',
  },
  google: {
    name: 'Google',
    icon: () => (
    ...
    linkUrl: '/api/auth/oauth/google/link',
  },
}
...
export default function AccountsPage() {
  ...
  const confirmUnlink = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/auth/oauth/unlink/${accountToDelete.provider}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
        },
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Link more accounts to enable additional sign-in methods</CardDescription>
          </CardHeader>
